                ...
                <div className={'w-full h-full flex justify-center items-center p-4'}>
                    <div className={'border p-4 rounded-md space-y-8 w-full max-w-[700px]'}>
                        <div className={'flex gap-5 items-center'}>
                            <Image
                                src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToCzYIw30n0l1WyhB2iDE3aeH3NrOKuoofGg&s'}
                        ...
                        <form className={'space-y-8'} onSubmit={submit}>
                            <div className={'space-y-2'}>
                                <Input
                                    label={'Artgrid URL'}
                                    placeholder={'Enter Artgrid URL'}
                                    variant={'flat'}
                                    value={envatoUrl}
                                    onChange={(e) => setEnvatoUrl(e.target.value)}
                                />
                                <div className={'font-light text-xs translate-x-2 text-default-400'}>
                                    example: https://artgrid.io/clip/518484/cheering-shouting-football-fans-celebrating
                                </div>
                            </div>
                            <Button
                                fullWidth
