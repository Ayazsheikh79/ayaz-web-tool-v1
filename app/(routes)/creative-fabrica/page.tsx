                    ...
                    <div className={'border p-4 rounded-md space-y-8 w-full max-w-[700px]'}>
                        ...
                        <form className={'space-y-8'} onSubmit={submit}>
                            <div className={'space-y-2'}>
                                <Input
                                    label={'Creative Fabrica URL'}
                                    placeholder={'Enter Creative Fabrica URL'}
                                    variant={'flat'}
                                    value={envatoUrl}
                                    onChange={(e) => setEnvatoUrl(e.target.value)}
                                />
                                <div className={'font-light text-xs translate-x-2 text-default-400'}>
                                    example: https://www.creativefabrica.com/product/the-script-collection-bundle/
                                </div>
                            </div>
                            <Button
                                fullWidth
