                ...
                <div className={'w-full h-full flex justify-center items-center p-4'}>
                    <div className={'border p-4 rounded-md space-y-8 w-full max-w-[700px]'}>
                        <div className={'flex gap-5 items-center'}>
                            <Image
                                src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZ6iTITE6TcDhfgBi7JjqyWzJK1aV4oRNW0Q&s'}
                                alt={'Storyblocks Downloader'}
                                width={50}
                                height={50}
                                className={'rounded-full'}
                            />
                            <div className={'font-semibold text-xl'}>
                                Storyblocks Footage Downloader
                            </div>
                        </div>
                        ...
                        <form className={'space-y-8'} onSubmit={submit}>
                            <div className={'space-y-2'}>
                                <Input
                                    label={'Storyblocks URL'}
                                    placeholder={'Enter Storyblocks URL'}
                                    variant={'flat'}
                                    value={envatoUrl}
                                    onChange={(e) => setEnvatoUrl(e.target.value)}
                                />
                                <div className={'font-light text-xs translate-x-2 text-default-400'}>
                                    example: https://www.storyblocks.com/video/stock/scenic-view-of-rainbow-above-victoria-falls-matabeleland-north-zimbabwe-349149329
                                </div>
                            </div>
                            <Button
                                fullWidth
